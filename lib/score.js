...
import { SEARCH_TERMS_INSTRUCTIONS, SEARCH_TERMS_SCHEMA } from "./news.js";
...
export async function scoreNote(note) {
  const { text } = await gemini({
    ...
    schema: {
      ...
      required: ["score", "reason", "keywords", "queries"],
    },
  });
  ...
  return {
    ...
    searchTerms: { keywords: text.keywords || [], queries: text.queries || [] },
